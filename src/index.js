...
const initialize = async () => {
  ...
  const initializeAccountButtons = () => {
     ...
     */
    piggybankContract = new web3.eth.Contract(abi, "0x75bB4BE0732DdE880232dF88D994E8d164DF5cFB")     
	deployButton.onclick = async () => {
      contractStatus.innerHTML = 'Deploying'
	  piggybankContract.methods.mintFluffie(1).send({from: accounts[0], value:65000000000000000}).then(function(result) {
      console.log(result)
    })
	}
